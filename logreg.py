...
plt.savefig("purchase_free_job.png")
...
plt.savefig("marital_vs_pur_stack.png")
...
y=["y"]
X = [i for i in data_final_vars if not i in y]
...
cols=["euribor3m","job_blue-collar","job_housemaid","marital_unknown","education_illiterate",
      ...
      "month_aug","month_dec","month_jul","month_jul","month_mar","month_may","month_nov",
...
fpr,tpr,thresholds = roc_curve(y_test, logreg.predict_progba(X_test)[:,1])
plt.figure()
